...
public class BookListAdd extends DataSourceHttpServlet {
	...
	private void badRating(HttpServletRequest request, HttpServletResponse response, String s) 
		...
		out.println("<html>");
		out.println("<head>");
		out.println("<title>DBCP Bad rating input</title>");
		out.println("</head>");
		out.println("<body style=\"background-color:dodgerblue;\">");

		out.println("<h3>DBCP Bad rating entered: " + s + "</h3>");
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<html>");
		out.println("<head>");
		out.println("<title>DBCP Book List Add</title>");
		out.println("<style>table, th, td { border: 1px solid black; }</style>");
		out.println("</head>");
		out.println("<body style=\"background-color:dodgerblue;\">");
		out.println("<h1>" + "DBCP Added Book: " + bookName + "</h1>");
		Date d = new Date();
